...
<?php
            ...
            ?>
                ...
                <a class="logo" href="#"><b><img src="<?php echo base_url() ."uploads/system_logo/" . $row['exhibition_logo'] ;?>" class="img-fluid" alt="home"/></b><small class="hidden-xs" style="display:inline !important;"><strong>
